...
(setq rmt-keywords '("sorts" "subsort" "signature" "variables" "rewrite-system" "constrained-rewrite-system" "smt-narrow-search" "smt-unify" "smt-implies" "smt-satisfiability" "smt-prove" "show-equivalent" "with-base"))
